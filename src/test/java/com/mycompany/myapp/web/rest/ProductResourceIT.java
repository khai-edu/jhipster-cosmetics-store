...
class ProductResourceIT {
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getStockCount()).isEqualTo(DEFAULT_STOCK_COUNT);
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getStockCount()).isEqualTo(UPDATED_STOCK_COUNT);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.imageUrl(UPDATED_IMAGE_URL);
